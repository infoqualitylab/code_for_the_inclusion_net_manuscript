#
# R1_salt_ggraph_srr3.R
#
# author: Yuanxi Fu
#
# Description: this file is responsible for generating Figure 3(a) of the manuscript
...
rank_srr_3 <- V(G)[V(G)$name == '3']$temporal_seq_rank

G <- G %>% activate(nodes) %>% 
  mutate(before_after = ifelse(temporal_seq_rank <= rank_srr_3, TRUE, FALSE))
