...
# adjusted_JS.R
#
# This file generate Figure 8 and Figure 9 of manuscript "Exploring Evidence Selection with the Inclusion Network"
  ...
  for (srr_2_name in srr_list) {
    ...
    if (srr_1_name != srr_2_name){
      ...
      adjusted_js_vector <- c(adjusted_js_vector, 
                              adjusted_js(srr_1_name, srr_2_name, G_exrx))
...
for (srr_1_name in srr_list){
  ...
  for (srr_2_name in srr_list) {
    ...
    if (srr_1_name != srr_2_name){
      ...
      adjusted_js_vector <- c(adjusted_js_vector, 
                              adjusted_js(srr_1_name, srr_2_name, G_salt))
    }
  }
}
